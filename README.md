...
* Navigate to the [latest release](https://github.com/Hoomee90/capstone/releases/latest)
* Download the zip file under the release
* Unzip the file
* Run magical-girl-story.exe